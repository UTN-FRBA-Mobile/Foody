...
class MainComposeActivity : ComponentActivity() {
    lateinit var dbHelper: ConnectionClass
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            AppNavigation(viewModel, orderViewModel, cardViewModel, groupViewModel, dbHelper)
        }
    ...
    fun createTestData(viewModel: OrderViewModel) {
        ...
        val orderItems1 = listOf(
            OrderItemInfo(dish = dish1, quantity = 2, id = 1),
            OrderItemInfo(dish = dish2, quantity = 1, id = 2)
        )
        val orderItems2 = listOf(
            OrderItemInfo(dish = dish2, quantity = 3, id = 2),
            OrderItemInfo(dish = dish1, quantity = 1, id = 3)
        )
        val orderItems3 = listOf(OrderItemInfo(dish = dish2, quantity = 2, id = 3))
        val orderItems4 = listOf(
            OrderItemInfo(dish = dish1, quantity = 4, id = 4),
            OrderItemInfo(dish = dish2, quantity = 2, id = 1)
        )
        val orderItems5 = listOf(OrderItemInfo(dish = dish1, quantity = 1, id = 5))

        val user1 = User(userId = 1, userName = "Alice", userPassword = "1234")
        val user2 = User(userId = 2, userName = "Bob", userPassword = "1234")
        val user3 = User(userId = 3, userName = "Charlie", userPassword = "1234")
        val user4 = User(userId = 4, userName = "Dave", userPassword = "1234")
        val user5 = User(userId = 5, userName = "Eve", userPassword = "1234")
